...
final class AIChatViewModel: ObservableObject, SpeechControlling {
    ...
    private var baseSystemPrompt: String {
        ...
        SystemPromptBuilder.identitySection()
            ...
            + "Separate confirmed facts, assumptions, and executed actions. Never fabricate tool calls, command output, success, CVEs, or credentials.\n"
            ...
            + "Respect authorization and safety boundaries. For live third-party systems, limit actions to read-only reconnaissance and verification unless the user explicitly authorizes a destructive action.\n\n"
