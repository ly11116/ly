...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.ly.minis.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.ly.minis.files")
