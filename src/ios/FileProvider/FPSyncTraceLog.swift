...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.ly.minis.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.ly.minis.FileProvider", category: "FPSyncTrace")
