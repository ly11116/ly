...
final class DebugJSONRPC: @unchecked Sendable {
    ...
    private func handleSyncCKQuery(params: [String: Any]) async -> Any {
        ...
        let container = CKContainer(identifier: "iCloud.com.ly.minis")
        do {
    ...
    private func handleSyncZoneStats(params: [String: Any]) async -> Any {
        let containerId = "iCloud.com.ly.minis"
    ...
    /// installed XCTest automation service (bundle com.ly.minis.ictrl,
    ...
    static func forwardTapToICTRL(params: [String: Any]) async -> [String: Any]? {
        ...
        let bundleId = (params["ictrl_bundle_id"] as? String) ?? Bundle.main.bundleIdentifier ?? "com.ly.minis"
