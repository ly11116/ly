...
enum ProviderMigration {
    ...
    private static let migrationKey = "com.ly.minis.provider-migration-v1-done"
    private static let oauthMigrationKey = "com.ly.minis.provider-migration-oauth-v2-done"
    ...
    private static func migrate(store: ProviderConfigStore) {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ly.minis.anthropic-api-key") {
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ly.minis.gemini-api-key") {
            let instance = ProviderInstance(
        ...
        // API Key
        if let key = readLegacyKeychain(service: "com.ly.minis.openai-api-key") {
            let instance = ProviderInstance(
    ...
    private static func loadLegacyAgentModelSettings() -> LegacyAgentModelSettings {
        let key = "com.ly.minis.agent-model-settings"
    ...
    private static func isLegacyActiveProvider(_ rawValue: String) -> Bool {
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrService as String: "com.ly.minis.active-provider",
